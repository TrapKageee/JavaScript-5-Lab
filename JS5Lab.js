 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting ("Ayi", "IL");
myGreeting.hello();
/*-------------------------------------------------------*/
// Question 3: myBook
console.log(`--------------------------
...
let yourBook = new Book ("The Son of Poseidon", "Rick Riordan");
...
class Fruit {
  ...
  describeFruit() {
    return `${this.name} is ${this.color} and has a ${this.taste} taste.`
  }
}
...
class List {
  ...
  displayMovies() {
    let movieInfo = "";
    for (let i = o; i < this.movieslength; i++) {
